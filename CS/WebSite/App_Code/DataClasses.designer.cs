...
public partial class Product : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private System.Nullable<decimal> _DecimalTest;
    ...
    partial void OnDecimalTestChanging(System.Nullable<decimal> value);
    partial void OnDecimalTestChanged();
    #endregion
	...
	[Column(Storage="_DecimalTest", DbType="Decimal(18,0)", UpdateCheck=UpdateCheck.Never)]
	public System.Nullable<decimal> DecimalTest
	{
		get
		{
			return this._DecimalTest;
		}
		set
		{
			if ((this._DecimalTest != value))
			{
				this.OnDecimalTestChanging(value);
				this.SendPropertyChanging();
				this._DecimalTest = value;
				this.SendPropertyChanged("DecimalTest");
				this.OnDecimalTestChanged();
			}
		}
	}
