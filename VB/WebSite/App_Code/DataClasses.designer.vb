...
Partial Public Class Product
	...
	Private _DecimalTest As System.Nullable(Of Decimal)
	...
	End Sub
	Partial Private Sub OnDecimalTestChanging(ByVal value As System.Nullable(Of Decimal))
	End Sub
	Partial Private Sub OnDecimalTestChanged()
	End Sub
	#End Region
	...
	<Column(Storage:="_DecimalTest", DbType:="Decimal(18,0)", UpdateCheck:=UpdateCheck.Never)> _
	Public Property DecimalTest() As System.Nullable(Of Decimal)
		Get
			Return Me._DecimalTest
		End Get
		Set(ByVal value As System.Nullable(Of Decimal))
			If (Not Me._DecimalTest.Equals(value)) Then
				Me.OnDecimalTestChanging(value)
				Me.SendPropertyChanging()
				Me._DecimalTest = value
				Me.SendPropertyChanged("DecimalTest")
				Me.OnDecimalTestChanged()
			End If
		End Set
	End Property
